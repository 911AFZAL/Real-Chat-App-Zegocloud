...
export declare class ZIMSDK {
     ...
     */
    sendMediaMessage(message: ZIMImageMessage | ZIMFileMessage | ZIMAudioMessage | ZIMVideoMessage, toConversationID: string, conversationType: ZIM.ConversationType, config: ZIMMessageSendConfig, notification?: ZIMMessageSendNotification): Promise<ZIMMessageSentResult>;
    sendMessage(message: ZIMCommandMessage | ZIMBarrageMessage | ZIMTextMessage | ZIMCustomMessage | ZIMCombineMessage | ZIMMultipleMessage | ZIMImageMessage | ZIMFileMessage | ZIMAudioMessage | ZIMVideoMessage, toConversationID: string, conversationType: ZIM.ConversationType, config: ZIMMessageSendConfig, notification?: ZIMMessageSendNotification): Promise<ZIMMessageSentResult>;
    editMessage(message: ZIMTextMessage | ZIMCustomMessage | ZIMMultipleMessage | ZIMImageMessage | ZIMFileMessage | ZIMAudioMessage | ZIMVideoMessage, config: ZIMMessageEditConfig, notification?: ZIMMessageSendNotification): Promise<ZIMMessageEditedResult>;
    replyMessage(message: ZIMTextMessage | ZIMCustomMessage | ZIMCombineMessage | ZIMMultipleMessage | ZIMImageMessage | ZIMFileMessage | ZIMAudioMessage | ZIMVideoMessage, toOriginalMessage: ZIMMessage, config: ZIMMessageSendConfig, notification?: ZIMMessageSendNotification): Promise<ZIMMessageSentResult>;
    insertMessageToLocalDB(message: ZIMTextMessage | ZIMCustomMessage | ZIMCombineMessage | ZIMMultipleMessage | ZIMImageMessage | ZIMFileMessage | ZIMAudioMessage | ZIMVideoMessage, conversationID: string, conversationType: ZIM.ConversationType, senderUserID: string): Promise<ZIMMessageInsertedResult>;
